...
//New Changed code without responsiveness
...
//   MenuList,
// } from '@chakra-ui/react';
// import { FiMenu, FiBell, FiChevronDown, FiUser, FiSearch } from 'react-icons/fi';
// import { FiHome, FiTrendingUp, FiCompass, FiStar, FiSettings } from 'react-icons/fi';
// import { VscOrganization } from 'react-icons/vsc';
// import { IconType } from 'react-icons';
// import { Link } from 'react-router-dom';
...
//   { name: 'Admins', icon: FiUser, to: '/admins' },
//   { name: 'Organizations', icon: VscOrganization, to: '/org' },
//   { name: 'Fundraising', icon: FiTrendingUp, to: '/funds' },
// ];
...
//       <Flex display={{ base: 'flex', md: 'none' }} px={4} h="20" alignItems="center" bg="white" borderBottom="1px" borderBottomColor="gray.200" justifyContent="space-between">
//         <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold">
//           Logo
//         </Text>
//         <IconButton icon={<FiMenu />} onClick={onOpen} variant="outline" aria-label="open menu" />
//       </Flex>

//       {/* Hamburger icon menu for mobile and tablet */}
//       <Drawer
//         autoFocus={false}
//         isOpen={isOpen}
//         placement="left"
...
// const NavItem = ({ to, icon, children, onClick }: { to: string; icon: IconType; children: React.ReactNode; onClick: () => void }) => {
//   return (
//     <Link to={to} style={{ textDecoration: 'none' }} _focus={{ boxShadow: 'none' }} onClick={onClick}>
//       <Flex
//         align="center"
//         p="4"
//         mx="4"
